...
import (
	...
	rayclusterv1alpha1 "github.com/ray-project/ray-contrib/ray-operator/api/raycluster/v1alpha1"
	versioned "github.com/ray-project/ray-contrib/ray-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ray-project/ray-contrib/ray-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/ray-project/ray-contrib/ray-operator/pkg/client/listers/raycluster/v1alpha1"
...
type RayClusterInformer interface {
	...
	Lister() v1alpha1.RayClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RayclusterV1alpha1().RayClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RayclusterV1alpha1().RayClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&rayclusterv1alpha1.RayCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *rayClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rayclusterv1alpha1.RayCluster{}, f.defaultInformer)
}

func (f *rayClusterInformer) Lister() v1alpha1.RayClusterLister {
	return v1alpha1.NewRayClusterLister(f.Informer().GetIndexer())
}
