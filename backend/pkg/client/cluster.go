...
import (
	...
	"github.com/ray-project/ray-contrib/backend/pkg/util"
	...
	rayclusterclient "github.com/ray-project/ray-contrib/ray-operator/pkg/client/clientset/versioned"
	rayiov1alpha1 "github.com/ray-project/ray-contrib/ray-operator/pkg/client/clientset/versioned/typed/raycluster/v1alpha1"
	"k8s.io/klog/v2"
)
...
type RayClusterClient struct {
	client rayiov1alpha1.RayclusterV1alpha1Interface
}
...
func NewRayClusterClientOrFatal(initConnectionTimeout time.Duration, options util.ClientOptions) ClusterClientInterface {
	var rayClusterClient rayiov1alpha1.RayclusterV1alpha1Interface
	var err error
	var operation = func() error {
		...
		rayClusterClient = rayclusterclient.NewForConfigOrDie(restConfig).RayclusterV1alpha1()
		return nil
	}
...
func newOutOfClusterRayClusterClient(err error, rayClusterClient rayiov1alpha1.RayclusterV1alpha1Interface) (rayiov1alpha1.RayclusterV1alpha1Interface, error) {
	...
	rayClusterClient = rayclusterclient.NewForConfigOrDie(config).RayclusterV1alpha1()
