...
type RayClusterLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.RayCluster, err error)
...
// List lists all RayClusters in the indexer.
func (s *rayClusterLister) List(selector labels.Selector) (ret []*v1alpha1.RayCluster, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.RayCluster))
	})
	return ret, err
}
...
type RayClusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.RayCluster, error)
...
// List lists all RayClusters in the indexer for a given namespace.
func (s rayClusterNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.RayCluster, err error) {
...
// Get retrieves the RayCluster from the indexer for a given namespace and name.
func (s rayClusterNamespaceLister) Get(name string) (*v1alpha1.RayCluster, error) {
