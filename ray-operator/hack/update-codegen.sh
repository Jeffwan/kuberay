...
ROOT_PKG=github.com/ray-project/ray-contrib/ray-operator
...
${CODEGEN_PKG}/generate-groups.sh "client,informer,lister" \
 github.com/ray-project/ray-contrib/ray-operator/pkg/client github.com/ray-project/ray-contrib/ray-operator/api \
 raycluster:v1alpha1 \
