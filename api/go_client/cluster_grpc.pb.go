...
type ClusterServiceClient interface {
	...
	ArchiveCluster(ctx context.Context, in *ArchiveClusterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// Restores an archived cluster. The Cluster's archived runs and jobs
	// will stay archived.
	UnarchiveCluster(ctx context.Context, in *UnarchiveClusterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *clusterServiceClient) CreateCluster(ctx context.Context, in *CreateClusterRequest, opts ...grpc.CallOption) (*Cluster, error) {
	out := new(Cluster)
	err := c.cc.Invoke(ctx, "/api.ClusterService/CreateCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) GetCluster(ctx context.Context, in *GetClusterRequest, opts ...grpc.CallOption) (*Cluster, error) {
	out := new(Cluster)
	err := c.cc.Invoke(ctx, "/api.ClusterService/GetCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) ListCluster(ctx context.Context, in *ListClustersRequest, opts ...grpc.CallOption) (*ListClustersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ClusterService/ListCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) DeleteCluster(ctx context.Context, in *DeleteClusterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ClusterService/DeleteCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) ArchiveCluster(ctx context.Context, in *ArchiveClusterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/api.ClusterService/ArchiveCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) UnarchiveCluster(ctx context.Context, in *UnarchiveClusterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/api.ClusterService/UnarchiveCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClusterServiceServer interface {
	...
	// Archives an cluster and the cluster's runs and jobs.
	ArchiveCluster(context.Context, *ArchiveClusterRequest) (*emptypb.Empty, error)
	// Restores an archived cluster. The Cluster's archived runs and jobs
	// will stay archived.
	UnarchiveCluster(context.Context, *UnarchiveClusterRequest) (*emptypb.Empty, error)
...
func (UnimplementedClusterServiceServer) ArchiveCluster(context.Context, *ArchiveClusterRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ArchiveCluster not implemented")
}
func (UnimplementedClusterServiceServer) UnarchiveCluster(context.Context, *UnarchiveClusterRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnarchiveCluster not implemented")
}
...
func _ClusterService_CreateCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/CreateCluster",
	}
...
func _ClusterService_GetCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/GetCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterService_ListCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/ListCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterService_DeleteCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/DeleteCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterService_ArchiveCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArchiveClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServiceServer).ArchiveCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/ArchiveCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).ArchiveCluster(ctx, req.(*ArchiveClusterRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ClusterService_UnarchiveCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnarchiveClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServiceServer).UnarchiveCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ClusterService/UnarchiveCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).UnarchiveCluster(ctx, req.(*UnarchiveClusterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClusterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ArchiveCluster",
			Handler:    _ClusterService_ArchiveCluster_Handler,
		},
		{
			MethodName: "UnarchiveCluster",
			Handler:    _ClusterService_UnarchiveCluster_Handler,
		},
	},
